// TODO: Create a tool that is going to trigger repo getter agent and strucutred output to get the git url of the library
...
export const getRepoUrlTool = createTool({
  ...
  description: "Resolves a JS/TS library name (e.g. 'zod', 'react', 'drizzle-orm') to its GitHub repository URL by querying the repo-getter agent.",
